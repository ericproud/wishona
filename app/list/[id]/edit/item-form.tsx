...
export default function ItemForm({ listId }: { listId: string }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-start justify-center pt-20 px-4">
      <form
        action={action}
        className="bg-card border border-border rounded-lg p-6 w-full max-w-md shadow-lg space-y-4"
      >
        ...
        <Button type="submit" disabled={isPending || isScraping} className="w-full">
