...
#### Request access CTA on access-denied page — PR #30 open (2026-05-09)
- [ ] Email form on access-denied page; visitor enters email → owner notified via Resend; success state replaces form
